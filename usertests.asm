...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
      ...
      16:	e8 bd 3d 00 00       	call   3dd8 <printf>
  fd = open("echo", 0);
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      ...
      48:	e8 8b 3d 00 00       	call   3dd8 <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      ...
      8a:	e8 49 3d 00 00       	call   3dd8 <printf>
    exit();
  ...
  printf(stdout, "open test ok\n");
      ...
      a4:	e8 2f 3d 00 00       	call   3dd8 <printf>
}
      a9:	c9                   	leave  
      aa:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      ...
      c1:	e8 12 3d 00 00       	call   3dd8 <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      ...
      f3:	e8 e0 3c 00 00       	call   3dd8 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     114:	e8 bf 3c 00 00       	call   3dd8 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     155:	e8 7e 3c 00 00       	call   3dd8 <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     196:	e8 3d 3c 00 00       	call   3dd8 <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     ...
     1be:	e8 15 3c 00 00       	call   3dd8 <printf>
  close(fd);
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     1fb:	e8 d8 3b 00 00       	call   3dd8 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     239:	e8 9a 3b 00 00       	call   3dd8 <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     ...
     253:	e8 80 3b 00 00       	call   3dd8 <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     ...
     285:	e8 4e 3b 00 00       	call   3dd8 <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     ...
     29f:	e8 34 3b 00 00       	call   3dd8 <printf>
    exit();
  ...
  printf(stdout, "small file test ok\n");
     ...
     2b9:	e8 1a 3b 00 00       	call   3dd8 <printf>
}
     2be:	c9                   	leave  
     2bf:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     2d6:	e8 fd 3a 00 00       	call   3dd8 <printf>
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     308:	e8 cb 3a 00 00       	call   3dd8 <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     35e:	e8 75 3a 00 00       	call   3dd8 <printf>
      exit();
  ...
  for(i = 0; i < MAXFILE; i++){
     ...
     36f:	3d 09 41 00 00       	cmp    $0x4109,%eax
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     3ae:	e8 25 3a 00 00       	call   3dd8 <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     3e1:	75 4c                	jne    42f <writetest1+0x16f>
      if(n == MAXFILE - 1){
     3e3:	81 7d f0 09 41 00 00 	cmpl   $0x4109,-0x10(%ebp)
     3ea:	75 21                	jne    40d <writetest1+0x14d>
        printf(stdout, "read only %d blocks from big", n);
     3ec:	a1 fc 5e 00 00       	mov    0x5efc,%eax
     3f1:	8b 55 f0             	mov    -0x10(%ebp),%edx
     3f4:	89 54 24 08          	mov    %edx,0x8(%esp)
     3f8:	c7 44 24 04 ad 43 00 	movl   $0x43ad,0x4(%esp)
     3ff:	00 
     400:	89 04 24             	mov    %eax,(%esp)
     403:	e8 d0 39 00 00       	call   3dd8 <printf>
        exit();
  ...
  if(unlink("big") < 0){
     419:	c7 04 24 58 43 00 00 	movl   $0x4358,(%esp)
     ...
     438:	a1 fc 5e 00 00       	mov    0x5efc,%eax
     43d:	8b 55 f4             	mov    -0xc(%ebp),%edx
     440:	89 54 24 08          	mov    %edx,0x8(%esp)
     444:	c7 44 24 04 ca 43 00 	movl   $0x43ca,0x4(%esp)
     44b:	00 
     44c:	89 04 24             	mov    %eax,(%esp)
     44f:	e8 84 39 00 00       	call   3dd8 <printf>
      exit();
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     49a:	a1 fc 5e 00 00       	mov    0x5efc,%eax
     49f:	c7 44 24 04 fc 43 00 	movl   $0x43fc,0x4(%esp)
     4a6:	00 
     4a7:	89 04 24             	mov    %eax,(%esp)
     4aa:	e8 29 39 00 00       	call   3dd8 <printf>
    exit();
     4af:	e8 64 37 00 00       	call   3c18 <exit>
  }
  printf(stdout, "big files ok\n");
     4b4:	a1 fc 5e 00 00       	mov    0x5efc,%eax
     4b9:	c7 44 24 04 0f 44 00 	movl   $0x440f,0x4(%esp)
     4c0:	00 
     4c1:	89 04 24             	mov    %eax,(%esp)
     4c4:	e8 0f 39 00 00       	call   3dd8 <printf>
}
     4c9:	c9                   	leave  
     4ca:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4d1:	a1 fc 5e 00 00       	mov    0x5efc,%eax
     4d6:	c7 44 24 04 20 44 00 	movl   $0x4420,0x4(%esp)
     4dd:	00 
     4de:	89 04 24             	mov    %eax,(%esp)
     4e1:	e8 f2 38 00 00       	call   3dd8 <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56c:	a1 fc 5e 00 00       	mov    0x5efc,%eax
     571:	c7 44 24 04 48 44 00 	movl   $0x4448,0x4(%esp)
     578:	00 
     579:	89 04 24             	mov    %eax,(%esp)
     57c:	e8 57 38 00 00       	call   3dd8 <printf>
}
     581:	c9                   	leave  
     582:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     589:	a1 fc 5e 00 00       	mov    0x5efc,%eax
     58e:	c7 44 24 04 6e 44 00 	movl   $0x446e,0x4(%esp)
     595:	00 
     596:	89 04 24             	mov    %eax,(%esp)
     599:	e8 3a 38 00 00       	call   3dd8 <printf>

  if(mkdir("dir0") < 0){
     59e:	c7 04 24 7a 44 00 00 	movl   $0x447a,(%esp)
     5a5:	e8 d6 36 00 00       	call   3c80 <mkdir>
     5aa:	85 c0                	test   %eax,%eax
     5ac:	79 1a                	jns    5c8 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     5ae:	a1 fc 5e 00 00       	mov    0x5efc,%eax
     5b3:	c7 44 24 04 7f 44 00 	movl   $0x447f,0x4(%esp)
     5ba:	00 
     5bb:	89 04 24             	mov    %eax,(%esp)
     5be:	e8 15 38 00 00       	call   3dd8 <printf>
    exit();
     5c3:	e8 50 36 00 00       	call   3c18 <exit>
  }

  if(chdir("dir0") < 0){
     5c8:	c7 04 24 7a 44 00 00 	movl   $0x447a,(%esp)
     5cf:	e8 b4 36 00 00       	call   3c88 <chdir>
     5d4:	85 c0                	test   %eax,%eax
     5d6:	79 1a                	jns    5f2 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     5d8:	a1 fc 5e 00 00       	mov    0x5efc,%eax
     5dd:	c7 44 24 04 8d 44 00 	movl   $0x448d,0x4(%esp)
     5e4:	00 
     5e5:	89 04 24             	mov    %eax,(%esp)
     5e8:	e8 eb 37 00 00       	call   3dd8 <printf>
    exit();
     5ed:	e8 26 36 00 00       	call   3c18 <exit>
  }

  if(chdir("..") < 0){
     5f2:	c7 04 24 a0 44 00 00 	movl   $0x44a0,(%esp)
     5f9:	e8 8a 36 00 00       	call   3c88 <chdir>
     5fe:	85 c0                	test   %eax,%eax
     600:	79 1a                	jns    61c <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     602:	a1 fc 5e 00 00       	mov    0x5efc,%eax
     607:	c7 44 24 04 a3 44 00 	movl   $0x44a3,0x4(%esp)
     60e:	00 
     60f:	89 04 24             	mov    %eax,(%esp)
     612:	e8 c1 37 00 00       	call   3dd8 <printf>
    exit();
     617:	e8 fc 35 00 00       	call   3c18 <exit>
  }

  if(unlink("dir0") < 0){
     61c:	c7 04 24 7a 44 00 00 	movl   $0x447a,(%esp)
     623:	e8 40 36 00 00       	call   3c68 <unlink>
     628:	85 c0                	test   %eax,%eax
     62a:	79 1a                	jns    646 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     62c:	a1 fc 5e 00 00       	mov    0x5efc,%eax
     631:	c7 44 24 04 b4 44 00 	movl   $0x44b4,0x4(%esp)
     638:	00 
     639:	89 04 24             	mov    %eax,(%esp)
     63c:	e8 97 37 00 00       	call   3dd8 <printf>
    exit();
     641:	e8 d2 35 00 00       	call   3c18 <exit>
  }
  printf(stdout, "mkdir test\n");
     646:	a1 fc 5e 00 00       	mov    0x5efc,%eax
     64b:	c7 44 24 04 6e 44 00 	movl   $0x446e,0x4(%esp)
     652:	00 
     653:	89 04 24             	mov    %eax,(%esp)
     656:	e8 7d 37 00 00       	call   3dd8 <printf>
}
     65b:	c9                   	leave  
     65c:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     663:	a1 fc 5e 00 00       	mov    0x5efc,%eax
     668:	c7 44 24 04 c8 44 00 	movl   $0x44c8,0x4(%esp)
     66f:	00 
     670:	89 04 24             	mov    %eax,(%esp)
     673:	e8 60 37 00 00       	call   3dd8 <printf>
  if(exec("echo", echoargv) < 0){
     678:	c7 44 24 04 e8 5e 00 	movl   $0x5ee8,0x4(%esp)
     67f:	00 
     680:	c7 04 24 a4 41 00 00 	movl   $0x41a4,(%esp)
     687:	e8 c4 35 00 00       	call   3c50 <exec>
     68c:	85 c0                	test   %eax,%eax
     68e:	79 1a                	jns    6aa <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     690:	a1 fc 5e 00 00       	mov    0x5efc,%eax
     695:	c7 44 24 04 d3 44 00 	movl   $0x44d3,0x4(%esp)
     69c:	00 
     69d:	89 04 24             	mov    %eax,(%esp)
     6a0:	e8 33 37 00 00       	call   3dd8 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     6c1:	c7 44 24 04 e5 44 00 	movl   $0x44e5,0x4(%esp)
     6c8:	00 
     6c9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     6d0:	e8 03 37 00 00       	call   3dd8 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     753:	c7 44 24 04 f4 44 00 	movl   $0x44f4,0x4(%esp)
     75a:	00 
     75b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     762:	e8 71 36 00 00       	call   3dd8 <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7c9:	c7 44 24 04 02 45 00 	movl   $0x4502,0x4(%esp)
     7d0:	00 
     7d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     7d8:	e8 fb 35 00 00       	call   3dd8 <printf>
    ...
    if(total != 5 * 1033){
     ...
     83f:	c7 44 24 04 10 45 00 	movl   $0x4510,0x4(%esp)
     846:	00 
     847:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     84e:	e8 85 35 00 00       	call   3dd8 <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     868:	c7 44 24 04 36 45 00 	movl   $0x4536,0x4(%esp)
     86f:	00 
     870:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     877:	e8 5c 35 00 00       	call   3dd8 <printf>
    ...
    printf(1, "fork() failed\n");
     87e:	c7 44 24 04 27 45 00 	movl   $0x4527,0x4(%esp)
     885:	00 
     886:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     88d:	e8 46 35 00 00       	call   3dd8 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     89f:	c7 44 24 04 40 45 00 	movl   $0x4540,0x4(%esp)
     8a6:	00 
     8a7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     8ae:	e8 25 35 00 00       	call   3dd8 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     901:	00 
     902:	c7 44 24 04 4a 45 00 	movl   $0x454a,0x4(%esp)
     909:	00 
     ...
     917:	c7 44 24 04 4c 45 00 	movl   $0x454c,0x4(%esp)
     91e:	00 
     91f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     926:	e8 ad 34 00 00       	call   3dd8 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     963:	c7 44 24 04 60 45 00 	movl   $0x4560,0x4(%esp)
     96a:	00 
     96b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     972:	e8 61 34 00 00       	call   3dd8 <printf>
  ...
  printf(1, "kill... ");
     984:	c7 44 24 04 73 45 00 	movl   $0x4573,0x4(%esp)
     98b:	00 
     98c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     993:	e8 40 34 00 00       	call   3dd8 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     9b9:	c7 44 24 04 7c 45 00 	movl   $0x457c,0x4(%esp)
     9c0:	00 
     9c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9c8:	e8 0b 34 00 00       	call   3dd8 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     9dc:	c7 44 24 04 85 45 00 	movl   $0x4585,0x4(%esp)
     9e3:	00 
     9e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9eb:	e8 e8 33 00 00       	call   3dd8 <printf>
}
     9f0:	c9                   	leave  
     9f1:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a0d:	79 16                	jns    a25 <exitwait+0x33>
      printf(1, "fork failed\n");
     a0f:	c7 44 24 04 91 45 00 	movl   $0x4591,0x4(%esp)
     a16:	00 
     a17:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a1e:	e8 b5 33 00 00       	call   3dd8 <printf>
      return;
    ...
    if(pid){
     ...
     a35:	c7 44 24 04 9e 45 00 	movl   $0x459e,0x4(%esp)
     a3c:	00 
     a3d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a44:	e8 8f 33 00 00       	call   3dd8 <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     a5a:	c7 44 24 04 ae 45 00 	movl   $0x45ae,0x4(%esp)
     a61:	00 
     a62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a69:	e8 6a 33 00 00       	call   3dd8 <printf>
}
     a6e:	c9                   	leave  
     a6f:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     a76:	c7 44 24 04 bb 45 00 	movl   $0x45bb,0x4(%esp)
     a7d:	00 
     a7e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a85:	e8 4e 33 00 00       	call   3dd8 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     ac2:	e8 fd 35 00 00       	call   40c4 <malloc>
    ...
    while(m1){
     ...
     ae0:	e8 a6 34 00 00       	call   3f8b <free>
      m1 = m2;
    ...
    free(m1);
     ...
     b30:	e8 56 34 00 00       	call   3f8b <free>
    printf(1, "mem ok\n");
     b35:	c7 44 24 04 df 45 00 	movl   $0x45df,0x4(%esp)
     b3c:	00 
     b3d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b44:	e8 8f 32 00 00       	call   3dd8 <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     b5b:	c7 44 24 04 e7 45 00 	movl   $0x45e7,0x4(%esp)
     b62:	00 
     b63:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b6a:	e8 69 32 00 00       	call   3dd8 <printf>

  unlink("sharedfd");
     b6f:	c7 04 24 f6 45 00 00 	movl   $0x45f6,(%esp)
     b76:	e8 ed 30 00 00       	call   3c68 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     b7b:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     b82:	00 
     b83:	c7 04 24 f6 45 00 00 	movl   $0x45f6,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     b98:	c7 44 24 04 00 46 00 	movl   $0x4600,0x4(%esp)
     b9f:	00 
     ba0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ba7:	e8 2c 32 00 00       	call   3dd8 <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c0a:	c7 44 24 04 2c 46 00 	movl   $0x462c,0x4(%esp)
     c11:	00 
     c12:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c19:	e8 ba 31 00 00       	call   3dd8 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     c4f:	00 
     c50:	c7 04 24 f6 45 00 00 	movl   $0x45f6,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     c65:	c7 44 24 04 4c 46 00 	movl   $0x464c,0x4(%esp)
     c6c:	00 
     c6d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c74:	e8 5f 31 00 00       	call   3dd8 <printf>
    return;
  ...
  unlink("sharedfd");
     cf6:	c7 04 24 f6 45 00 00 	movl   $0x45f6,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d14:	c7 44 24 04 77 46 00 	movl   $0x4677,0x4(%esp)
     d1b:	00 
     d1c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d23:	e8 b0 30 00 00       	call   3dd8 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d38:	c7 44 24 04 84 46 00 	movl   $0x4684,0x4(%esp)
     d3f:	00 
     d40:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d47:	e8 8c 30 00 00       	call   3dd8 <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d59:	c7 44 24 04 99 46 00 	movl   $0x4699,0x4(%esp)
     d60:	00 
     d61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d68:	e8 6b 30 00 00       	call   3dd8 <printf>

  unlink("f1");
     d6d:	c7 04 24 a8 46 00 00 	movl   $0x46a8,(%esp)
     d74:	e8 ef 2e 00 00       	call   3c68 <unlink>
  unlink("f2");
     d79:	c7 04 24 ab 46 00 00 	movl   $0x46ab,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d93:	c7 44 24 04 91 45 00 	movl   $0x4591,0x4(%esp)
     d9a:	00 
     d9b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     da2:	e8 31 30 00 00       	call   3dd8 <printf>
    exit();
  ...
  fname = pid ? "f1" : "f2";
     ...
     db2:	b8 a8 46 00 00       	mov    $0x46a8,%eax
     db7:	eb 05                	jmp    dbe <twofiles+0x6b>
     db9:	b8 ab 46 00 00       	mov    $0x46ab,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     ddd:	c7 44 24 04 ae 46 00 	movl   $0x46ae,0x4(%esp)
     de4:	00 
     de5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     dec:	e8 e7 2f 00 00       	call   3dd8 <printf>
    exit();
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e57:	c7 44 24 04 bd 46 00 	movl   $0x46bd,0x4(%esp)
     e5e:	00 
     e5f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e66:	e8 6d 2f 00 00       	call   3dd8 <printf>
      exit();
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     ea7:	b8 a8 46 00 00       	mov    $0x46a8,%eax
     eac:	eb 05                	jmp    eb3 <twofiles+0x160>
     eae:	b8 ab 46 00 00       	mov    $0x46ab,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     efa:	74 19                	je     f15 <twofiles+0x1c2>
          printf(1, "wrong char\n");
     efc:	c7 44 24 04 ce 46 00 	movl   $0x46ce,0x4(%esp)
     f03:	00 
     f04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f0b:	e8 c8 2e 00 00       	call   3dd8 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    if(total != 12*500){
     ...
     f66:	c7 44 24 04 da 46 00 	movl   $0x46da,0x4(%esp)
     f6d:	00 
     f6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f75:	e8 5e 2e 00 00       	call   3dd8 <printf>
      exit();
  ...
  unlink("f1");
     f8d:	c7 04 24 a8 46 00 00 	movl   $0x46a8,(%esp)
     f94:	e8 cf 2c 00 00       	call   3c68 <unlink>
  unlink("f2");
     f99:	c7 04 24 ab 46 00 00 	movl   $0x46ab,(%esp)
     fa0:	e8 c3 2c 00 00       	call   3c68 <unlink>

  printf(1, "twofiles ok\n");
     fa5:	c7 44 24 04 eb 46 00 	movl   $0x46eb,0x4(%esp)
     fac:	00 
     fad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fb4:	e8 1f 2e 00 00       	call   3dd8 <printf>
}
     fb9:	c9                   	leave  
     fba:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fc1:	c7 44 24 04 f8 46 00 	movl   $0x46f8,0x4(%esp)
     fc8:	00 
     fc9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fd0:	e8 03 2e 00 00       	call   3dd8 <printf>
  pid = fork();
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fe3:	c7 44 24 04 91 45 00 	movl   $0x4591,0x4(%esp)
     fea:	00 
     feb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ff2:	e8 e1 2d 00 00       	call   3dd8 <printf>
    exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1044:	79 19                	jns    105f <createdelete+0xa4>
      printf(1, "create failed\n");
    1046:	c7 44 24 04 ae 46 00 	movl   $0x46ae,0x4(%esp)
    104d:	00 
    104e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1055:	e8 7e 2d 00 00       	call   3dd8 <printf>
      exit();
    ...
    109b:	c7 44 24 04 0b 47 00 	movl   $0x470b,0x4(%esp)
    10a2:	00 
    10a3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10aa:	e8 29 2d 00 00       	call   3dd8 <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    111a:	c7 44 24 04 1c 47 00 	movl   $0x471c,0x4(%esp)
    1121:	00 
    1122:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1129:	e8 aa 2c 00 00       	call   3dd8 <printf>
      exit();
    ...
    114c:	c7 44 24 04 40 47 00 	movl   $0x4740,0x4(%esp)
    1153:	00 
    1154:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    115b:	e8 78 2c 00 00       	call   3dd8 <printf>
      exit();
    ...
    11b2:	c7 44 24 04 1c 47 00 	movl   $0x471c,0x4(%esp)
    11b9:	00 
    11ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11c1:	e8 12 2c 00 00       	call   3dd8 <printf>
      exit();
    ...
    11e4:	c7 44 24 04 40 47 00 	movl   $0x4740,0x4(%esp)
    11eb:	00 
    11ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11f3:	e8 e0 2b 00 00       	call   3dd8 <printf>
      exit();
  ...
  printf(1, "createdelete ok\n");
    1256:	c7 44 24 04 60 47 00 	movl   $0x4760,0x4(%esp)
    125d:	00 
    125e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1265:	e8 6e 2b 00 00       	call   3dd8 <printf>
}
    126a:	c9                   	leave  
    126b:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1272:	c7 44 24 04 71 47 00 	movl   $0x4771,0x4(%esp)
    1279:	00 
    127a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1281:	e8 52 2b 00 00       	call   3dd8 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1286:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    128d:	00 
    128e:	c7 04 24 82 47 00 00 	movl   $0x4782,(%esp)
  ...
  if(fd < 0){
    ...
    12a3:	c7 44 24 04 8d 47 00 	movl   $0x478d,0x4(%esp)
    12aa:	00 
    12ab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12b2:	e8 21 2b 00 00       	call   3dd8 <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    12c3:	00 
    12c4:	c7 44 24 04 a7 47 00 	movl   $0x47a7,0x4(%esp)
    12cb:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e9:	00 
    12ea:	c7 04 24 82 47 00 00 	movl   $0x4782,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    139e:	c7 44 24 04 e3 47 00 	movl   $0x47e3,0x4(%esp)
    13a5:	00 
    13a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13ad:	e8 26 2a 00 00       	call   3dd8 <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    13c2:	c7 44 24 04 fa 47 00 	movl   $0x47fa,0x4(%esp)
    13c9:	00 
    13ca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13d1:	e8 02 2a 00 00       	call   3dd8 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13fb:	c7 44 24 04 11 48 00 	movl   $0x4811,0x4(%esp)
    1402:	00 
    1403:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    140a:	e8 c9 29 00 00       	call   3dd8 <printf>
    exit();
  ...
  unlink("unlinkread");
    141f:	c7 04 24 82 47 00 00 	movl   $0x4782,(%esp)
    1426:	e8 3d 28 00 00       	call   3c68 <unlink>
  printf(1, "unlinkread ok\n");
    142b:	c7 44 24 04 2a 48 00 	movl   $0x482a,0x4(%esp)
    1432:	00 
    1433:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    143a:	e8 99 29 00 00       	call   3dd8 <printf>
}
    143f:	c9                   	leave  
    1440:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    1447:	c7 44 24 04 39 48 00 	movl   $0x4839,0x4(%esp)
    144e:	00 
    144f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1456:	e8 7d 29 00 00       	call   3dd8 <printf>

  unlink("lf1");
    145b:	c7 04 24 43 48 00 00 	movl   $0x4843,(%esp)
    1462:	e8 01 28 00 00       	call   3c68 <unlink>
  unlink("lf2");
    1467:	c7 04 24 47 48 00 00 	movl   $0x4847,(%esp)
    146e:	e8 f5 27 00 00       	call   3c68 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1473:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    147a:	00 
    147b:	c7 04 24 43 48 00 00 	movl   $0x4843,(%esp)
  ...
  if(fd < 0){
    ...
    1490:	c7 44 24 04 4b 48 00 	movl   $0x484b,0x4(%esp)
    1497:	00 
    1498:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    149f:	e8 34 29 00 00       	call   3dd8 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14b0:	00 
    14b1:	c7 44 24 04 a7 47 00 	movl   $0x47a7,0x4(%esp)
    14b8:	00 
    ...
    14c9:	c7 44 24 04 5e 48 00 	movl   $0x485e,0x4(%esp)
    14d0:	00 
    14d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14d8:	e8 fb 28 00 00       	call   3dd8 <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    1562:	00 
    1563:	c7 04 24 47 48 00 00 	movl   $0x4847,(%esp)
  ...
  if(fd < 0){
    ...
    1578:	c7 44 24 04 ad 48 00 	movl   $0x48ad,0x4(%esp)
    157f:	00 
    1580:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1587:	e8 4c 28 00 00       	call   3dd8 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    15b1:	c7 44 24 04 be 48 00 	movl   $0x48be,0x4(%esp)
    15b8:	00 
    15b9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15c0:	e8 13 28 00 00       	call   3dd8 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    15d5:	c7 44 24 04 47 48 00 	movl   $0x4847,0x4(%esp)
    15dc:	00 
    15dd:	c7 04 24 47 48 00 00 	movl   $0x4847,(%esp)
    15e4:	e8 8f 26 00 00       	call   3c78 <link>
    15e9:	85 c0                	test   %eax,%eax
    15eb:	78 19                	js     1606 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15ed:	c7 44 24 04 cf 48 00 	movl   $0x48cf,0x4(%esp)
    15f4:	00 
    15f5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15fc:	e8 d7 27 00 00       	call   3dd8 <printf>
    exit();
    1601:	e8 12 26 00 00       	call   3c18 <exit>
  }

  unlink("lf2");
    1606:	c7 04 24 47 48 00 00 	movl   $0x4847,(%esp)
    160d:	e8 56 26 00 00       	call   3c68 <unlink>
  if(link("lf2", "lf1") >= 0){
    1612:	c7 44 24 04 43 48 00 	movl   $0x4843,0x4(%esp)
    1619:	00 
    161a:	c7 04 24 47 48 00 00 	movl   $0x4847,(%esp)
    1621:	e8 52 26 00 00       	call   3c78 <link>
    1626:	85 c0                	test   %eax,%eax
    1628:	78 19                	js     1643 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    162a:	c7 44 24 04 f0 48 00 	movl   $0x48f0,0x4(%esp)
    1631:	00 
    1632:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1639:	e8 9a 27 00 00       	call   3dd8 <printf>
    exit();
    163e:	e8 d5 25 00 00       	call   3c18 <exit>
  }

  if(link(".", "lf1") >= 0){
    1643:	c7 44 24 04 43 48 00 	movl   $0x4843,0x4(%esp)
    164a:	00 
    164b:	c7 04 24 13 49 00 00 	movl   $0x4913,(%esp)
    1652:	e8 21 26 00 00       	call   3c78 <link>
    1657:	85 c0                	test   %eax,%eax
    1659:	78 19                	js     1674 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    165b:	c7 44 24 04 15 49 00 	movl   $0x4915,0x4(%esp)
    1662:	00 
    1663:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    166a:	e8 69 27 00 00       	call   3dd8 <printf>
    exit();
    166f:	e8 a4 25 00 00       	call   3c18 <exit>
  }

  printf(1, "linktest ok\n");
    1674:	c7 44 24 04 31 49 00 	movl   $0x4931,0x4(%esp)
    167b:	00 
    167c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1683:	e8 50 27 00 00       	call   3dd8 <printf>
}
    1688:	c9                   	leave  
    1689:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1690:	c7 44 24 04 3e 49 00 	movl   $0x493e,0x4(%esp)
    1697:	00 
    1698:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    169f:	e8 34 27 00 00       	call   3dd8 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1703:	c7 04 24 4e 49 00 00 	movl   $0x494e,(%esp)
    ...
    1746:	c7 04 24 4e 49 00 00 	movl   $0x494e,(%esp)
    ...
    1777:	c7 44 24 04 51 49 00 	movl   $0x4951,0x4(%esp)
    177e:	00 
    177f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1786:	e8 4d 26 00 00       	call   3dd8 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    17db:	00 
    17dc:	c7 04 24 13 49 00 00 	movl   $0x4913,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    183e:	c7 44 24 04 6d 49 00 	movl   $0x496d,0x4(%esp)
    1845:	00 
    1846:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    184d:	e8 86 25 00 00       	call   3dd8 <printf>
        exit();
    ...
    1870:	c7 44 24 04 86 49 00 	movl   $0x4986,0x4(%esp)
    1877:	00 
    1878:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    187f:	e8 54 25 00 00       	call   3dd8 <printf>
        exit();
  ...
  if(n != 40){
    ...
    18cb:	c7 44 24 04 a4 49 00 	movl   $0x49a4,0x4(%esp)
    18d2:	00 
    18d3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18da:	e8 f9 24 00 00       	call   3dd8 <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1905:	79 19                	jns    1920 <concreate+0x296>
      printf(1, "fork failed\n");
    1907:	c7 44 24 04 91 45 00 	movl   $0x4591,0x4(%esp)
    190e:	00 
    190f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1916:	e8 bd 24 00 00       	call   3dd8 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1a27:	c7 44 24 04 d5 49 00 	movl   $0x49d5,0x4(%esp)
    1a2e:	00 
    1a2f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a36:	e8 9d 23 00 00       	call   3dd8 <printf>
}
    1a3b:	c9                   	leave  
    1a3c:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a43:	c7 44 24 04 e3 49 00 	movl   $0x49e3,0x4(%esp)
    1a4a:	00 
    1a4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a52:	e8 81 23 00 00       	call   3dd8 <printf>

  unlink("x");
    1a57:	c7 04 24 4a 45 00 00 	movl   $0x454a,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a71:	c7 44 24 04 91 45 00 	movl   $0x4591,0x4(%esp)
    1a78:	00 
    1a79:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a80:	e8 53 23 00 00       	call   3dd8 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1adf:	00 
    1ae0:	c7 04 24 4a 45 00 00 	movl   $0x454a,(%esp)
    ...
    1b11:	75 16                	jne    1b29 <linkunlink+0xec>
      link("cat", "x");
    1b13:	c7 44 24 04 4a 45 00 	movl   $0x454a,0x4(%esp)
    1b1a:	00 
    1b1b:	c7 04 24 f4 49 00 00 	movl   $0x49f4,(%esp)
    1b22:	e8 51 21 00 00       	call   3c78 <link>
    1b27:	eb 0c                	jmp    1b35 <linkunlink+0xf8>
    } else {
      unlink("x");
    1b29:	c7 04 24 4a 45 00 00 	movl   $0x454a,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b55:	c7 44 24 04 f8 49 00 	movl   $0x49f8,0x4(%esp)
    1b5c:	00 
    1b5d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b64:	e8 6f 22 00 00       	call   3dd8 <printf>
}
    1b69:	c9                   	leave  
    1b6a:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1b71:	c7 44 24 04 07 4a 00 	movl   $0x4a07,0x4(%esp)
    1b78:	00 
    1b79:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b80:	e8 53 22 00 00       	call   3dd8 <printf>
  unlink("bd");
    1b85:	c7 04 24 14 4a 00 00 	movl   $0x4a14,(%esp)
    1b8c:	e8 d7 20 00 00       	call   3c68 <unlink>

  fd = open("bd", O_CREATE);
    1b91:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1b98:	00 
    1b99:	c7 04 24 14 4a 00 00 	movl   $0x4a14,(%esp)
  ...
  if(fd < 0){
    ...
    1bae:	c7 44 24 04 17 4a 00 	movl   $0x4a17,0x4(%esp)
    1bb5:	00 
    1bb6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1bbd:	e8 16 22 00 00       	call   3dd8 <printf>
    exit();
  ...
  unlink("bd");
    1c48:	c7 04 24 14 4a 00 00 	movl   $0x4a14,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c9c:	c7 44 24 04 41 4a 00 	movl   $0x4a41,0x4(%esp)
    1ca3:	00 
    1ca4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cab:	e8 28 21 00 00       	call   3dd8 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1cc2:	c7 44 24 04 56 4a 00 	movl   $0x4a56,0x4(%esp)
    1cc9:	00 
    1cca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cd1:	e8 02 21 00 00       	call   3dd8 <printf>
}
    1cd6:	c9                   	leave  
    1cd7:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1cde:	c7 44 24 04 61 4a 00 	movl   $0x4a61,0x4(%esp)
    1ce5:	00 
    1ce6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ced:	e8 e6 20 00 00       	call   3dd8 <printf>

  unlink("ff");
    1cf2:	c7 04 24 6e 4a 00 00 	movl   $0x4a6e,(%esp)
    1cf9:	e8 6a 1f 00 00       	call   3c68 <unlink>
  if(mkdir("dd") != 0){
    1cfe:	c7 04 24 71 4a 00 00 	movl   $0x4a71,(%esp)
    1d05:	e8 76 1f 00 00       	call   3c80 <mkdir>
    1d0a:	85 c0                	test   %eax,%eax
    1d0c:	74 19                	je     1d27 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1d0e:	c7 44 24 04 74 4a 00 	movl   $0x4a74,0x4(%esp)
    1d15:	00 
    1d16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d1d:	e8 b6 20 00 00       	call   3dd8 <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2e:	00 
    1d2f:	c7 04 24 8c 4a 00 00 	movl   $0x4a8c,(%esp)
  ...
  if(fd < 0){
    ...
    1d44:	c7 44 24 04 92 4a 00 	movl   $0x4a92,0x4(%esp)
    1d4b:	00 
    1d4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d53:	e8 80 20 00 00       	call   3dd8 <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1d64:	00 
    1d65:	c7 44 24 04 6e 4a 00 	movl   $0x4a6e,0x4(%esp)
    1d6c:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ddc:	00 
    1ddd:	c7 04 24 f0 4a 00 00 	movl   $0x4af0,(%esp)
  ...
  if(fd < 0){
    ...
    1df2:	c7 44 24 04 f9 4a 00 	movl   $0x4af9,0x4(%esp)
    1df9:	00 
    1dfa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e01:	e8 d2 1f 00 00       	call   3dd8 <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    1e12:	00 
    1e13:	c7 44 24 04 11 4b 00 	movl   $0x4b11,0x4(%esp)
    1e1a:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e38:	00 
    1e39:	c7 04 24 14 4b 00 00 	movl   $0x4b14,(%esp)
  ...
  if(fd < 0){
    ...
    1e4e:	c7 44 24 04 20 4b 00 	movl   $0x4b20,0x4(%esp)
    1e55:	00 
    1e56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e5d:	e8 76 1f 00 00       	call   3dd8 <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e96:	c7 44 24 04 39 4b 00 	movl   $0x4b39,0x4(%esp)
    1e9d:	00 
    1e9e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ea5:	e8 2e 1f 00 00       	call   3dd8 <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ff0:	00 
    1ff1:	c7 04 24 54 4b 00 00 	movl   $0x4b54,(%esp)
  ...
  if(fd < 0){
    ...
    2006:	c7 44 24 04 1e 4c 00 	movl   $0x4c1e,0x4(%esp)
    200d:	00 
    200e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2015:	e8 be 1d 00 00       	call   3dd8 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    203f:	c7 44 24 04 36 4c 00 	movl   $0x4c36,0x4(%esp)
    2046:	00 
    2047:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    204e:	e8 85 1d 00 00       	call   3dd8 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2424:	c7 44 24 04 b0 4e 00 	movl   $0x4eb0,0x4(%esp)
    242b:	00 
    242c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2433:	e8 a0 19 00 00       	call   3dd8 <printf>

  unlink("bigwrite");
    2438:	c7 04 24 bf 4e 00 00 	movl   $0x4ebf,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2457:	00 
    2458:	c7 04 24 bf 4e 00 00 	movl   $0x4ebf,(%esp)
    ...
    246d:	c7 44 24 04 c8 4e 00 	movl   $0x4ec8,0x4(%esp)
    2474:	00 
    2475:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    247c:	e8 57 19 00 00       	call   3dd8 <printf>
      exit();
    ...
    24c2:	c7 44 24 04 e0 4e 00 	movl   $0x4ee0,0x4(%esp)
    24c9:	00 
    24ca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24d1:	e8 02 19 00 00       	call   3dd8 <printf>
        exit();
    ...
    unlink("bigwrite");
    24f0:	c7 04 24 bf 4e 00 00 	movl   $0x4ebf,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    2510:	c7 44 24 04 f2 4e 00 	movl   $0x4ef2,0x4(%esp)
    2517:	00 
    2518:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    251f:	e8 b4 18 00 00       	call   3dd8 <printf>
}
    2524:	c9                   	leave  
    2525:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    252c:	c7 44 24 04 ff 4e 00 	movl   $0x4eff,0x4(%esp)
    2533:	00 
    2534:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    253b:	e8 98 18 00 00       	call   3dd8 <printf>

  unlink("bigfile");
    2540:	c7 04 24 0d 4f 00 00 	movl   $0x4f0d,(%esp)
    2547:	e8 1c 17 00 00       	call   3c68 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    254c:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    2553:	00 
    2554:	c7 04 24 0d 4f 00 00 	movl   $0x4f0d,(%esp)
  ...
  if(fd < 0){
    ...
    2569:	c7 44 24 04 15 4f 00 	movl   $0x4f15,0x4(%esp)
    2570:	00 
    2571:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2578:	e8 5b 18 00 00       	call   3dd8 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    25c8:	c7 44 24 04 2b 4f 00 	movl   $0x4f2b,0x4(%esp)
    25cf:	00 
    25d0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25d7:	e8 fc 17 00 00       	call   3dd8 <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    25fd:	00 
    25fe:	c7 04 24 0d 4f 00 00 	movl   $0x4f0d,(%esp)
  ...
  if(fd < 0){
    ...
    2613:	c7 44 24 04 41 4f 00 	movl   $0x4f41,0x4(%esp)
    261a:	00 
    261b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2622:	e8 b1 17 00 00       	call   3dd8 <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    265e:	c7 44 24 04 56 4f 00 	movl   $0x4f56,0x4(%esp)
    2665:	00 
    2666:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    266d:	e8 66 17 00 00       	call   3dd8 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    26a1:	c7 44 24 04 6b 4f 00 	movl   $0x4f6b,0x4(%esp)
    26a8:	00 
    26a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26b0:	e8 23 17 00 00       	call   3dd8 <printf>
      exit();
    ...
    26ec:	74 19                	je     2707 <bigfile+0x1e1>
      printf(1, "read bigfile wrong data\n");
    26ee:	c7 44 24 04 7f 4f 00 	movl   $0x4f7f,0x4(%esp)
    26f5:	00 
    26f6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26fd:	e8 d6 16 00 00       	call   3dd8 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    2716:	c7 44 24 04 98 4f 00 	movl   $0x4f98,0x4(%esp)
    271d:	00 
    271e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2725:	e8 ae 16 00 00       	call   3dd8 <printf>
    exit();
    272a:	e8 e9 14 00 00       	call   3c18 <exit>
  }
  unlink("bigfile");
    272f:	c7 04 24 0d 4f 00 00 	movl   $0x4f0d,(%esp)
    2736:	e8 2d 15 00 00       	call   3c68 <unlink>

  printf(1, "bigfile test ok\n");
    273b:	c7 44 24 04 b2 4f 00 	movl   $0x4fb2,0x4(%esp)
    2742:	00 
    2743:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    274a:	e8 89 16 00 00       	call   3dd8 <printf>
}
    274f:	c9                   	leave  
    2750:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27c4:	00 
    27c5:	c7 04 24 50 50 00 00 	movl   $0x5050,(%esp)
  ...
  if(fd < 0){
    ...
    27da:	c7 44 24 04 80 50 00 	movl   $0x5080,0x4(%esp)
    27e1:	00 
    27e2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27e9:	e8 ea 15 00 00       	call   3dd8 <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2805:	00 
    2806:	c7 04 24 c0 50 00 00 	movl   $0x50c0,(%esp)
  ...
  if(fd < 0){
    ...
    281b:	c7 44 24 04 f0 50 00 	movl   $0x50f0,0x4(%esp)
    2822:	00 
    2823:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    282a:	e8 a9 15 00 00       	call   3dd8 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a25:	c7 44 24 04 99 52 00 	movl   $0x5299,0x4(%esp)
    2a2c:	00 
    2a2d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a34:	e8 9f 13 00 00       	call   3dd8 <printf>

  fd = open("dirfile", O_CREATE);
    2a39:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2a40:	00 
    2a41:	c7 04 24 a6 52 00 00 	movl   $0x52a6,(%esp)
  ...
  if(fd < 0){
    ...
    2a56:	c7 44 24 04 ae 52 00 	movl   $0x52ae,0x4(%esp)
    2a5d:	00 
    2a5e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a65:	e8 6e 13 00 00       	call   3dd8 <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aaa:	00 
    2aab:	c7 04 24 df 52 00 00 	movl   $0x52df,(%esp)
  ...
  if(fd >= 0){
    ...
    2ac0:	c7 44 24 04 ea 52 00 	movl   $0x52ea,0x4(%esp)
    2ac7:	00 
    2ac8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2acf:	e8 04 13 00 00       	call   3dd8 <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ae0:	00 
    2ae1:	c7 04 24 df 52 00 00 	movl   $0x52df,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2bc2:	00 
    2bc3:	c7 04 24 13 49 00 00 	movl   $0x4913,(%esp)
  ...
  if(fd >= 0){
    ...
    2bd8:	c7 44 24 04 84 53 00 	movl   $0x5384,0x4(%esp)
    2bdf:	00 
    2be0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2be7:	e8 ec 11 00 00       	call   3dd8 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c27:	c7 44 24 04 a3 53 00 	movl   $0x53a3,0x4(%esp)
    2c2e:	00 
    2c2f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c36:	e8 9d 11 00 00       	call   3dd8 <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2c4b:	c7 44 24 04 b7 53 00 	movl   $0x53b7,0x4(%esp)
    2c52:	00 
    2c53:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c5a:	e8 79 11 00 00       	call   3dd8 <printf>
}
    2c5f:	c9                   	leave  
    2c60:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c67:	c7 44 24 04 c7 53 00 	movl   $0x53c7,0x4(%esp)
    2c6e:	00 
    2c6f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c76:	e8 5d 11 00 00       	call   3dd8 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2d28:	00 
    2d29:	c7 04 24 07 54 00 00 	movl   $0x5407,(%esp)
    ...
    unlink("xx");
    2d49:	c7 04 24 07 54 00 00 	movl   $0x5407,(%esp)
  ...
  chdir("/");
    2d63:	c7 04 24 2a 52 00 00 	movl   $0x522a,(%esp)
    2d6a:	e8 19 0f 00 00       	call   3c88 <chdir>
  printf(1, "empty file name OK\n");
    2d6f:	c7 44 24 04 0a 54 00 	movl   $0x540a,0x4(%esp)
    2d76:	00 
    2d77:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d7e:	e8 55 10 00 00       	call   3dd8 <printf>
}
    2d83:	c9                   	leave  
    2d84:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d8b:	c7 44 24 04 1e 54 00 	movl   $0x541e,0x4(%esp)
    2d92:	00 
    2d93:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d9a:	e8 39 10 00 00       	call   3dd8 <printf>
    ...
    2dbe:	e8 55 0e 00 00       	call   3c18 <exit>
{
  ...
  if(n == 1000){
    ...
    2dd9:	c7 44 24 04 2c 54 00 	movl   $0x542c,0x4(%esp)
    2de0:	00 
    2de1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2de8:	e8 eb 0f 00 00       	call   3dd8 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2dfd:	c7 44 24 04 4e 54 00 	movl   $0x544e,0x4(%esp)
    2e04:	00 
    2e05:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e0c:	e8 c7 0f 00 00       	call   3dd8 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    2e2a:	c7 44 24 04 62 54 00 	movl   $0x5462,0x4(%esp)
    2e31:	00 
    2e32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e39:	e8 9a 0f 00 00       	call   3dd8 <printf>
    exit();
    2e3e:	e8 d5 0d 00 00       	call   3c18 <exit>
  }
  
  printf(1, "fork test OK\n");
    2e43:	c7 44 24 04 75 54 00 	movl   $0x5475,0x4(%esp)
    2e4a:	00 
    2e4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e52:	e8 81 0f 00 00       	call   3dd8 <printf>
}
    2e57:	c9                   	leave  
    2e58:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e63:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    2e68:	c7 44 24 04 83 54 00 	movl   $0x5483,0x4(%esp)
    2e6f:	00 
    2e70:	89 04 24             	mov    %eax,(%esp)
    2e73:	e8 60 0f 00 00       	call   3dd8 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2eb6:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    ...
    2ed0:	c7 44 24 04 8e 54 00 	movl   $0x548e,0x4(%esp)
    2ed7:	00 
    2ed8:	89 04 24             	mov    %eax,(%esp)
    2edb:	e8 f8 0e 00 00       	call   3dd8 <printf>
      exit();
  ...
  if(pid < 0){
    ...
    2f0f:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    2f14:	c7 44 24 04 a9 54 00 	movl   $0x54a9,0x4(%esp)
    2f1b:	00 
    2f1c:	89 04 24             	mov    %eax,(%esp)
    2f1f:	e8 b4 0e 00 00       	call   3dd8 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    2f52:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    2f57:	c7 44 24 04 c0 54 00 	movl   $0x54c0,0x4(%esp)
    2f5e:	00 
    2f5f:	89 04 24             	mov    %eax,(%esp)
    2f62:	e8 71 0e 00 00       	call   3dd8 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2fb0:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    2fb5:	c7 44 24 04 dc 54 00 	movl   $0x54dc,0x4(%esp)
    2fbc:	00 
    2fbd:	89 04 24             	mov    %eax,(%esp)
    2fc0:	e8 13 0e 00 00       	call   3dd8 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ffb:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    3000:	c7 44 24 04 1a 55 00 	movl   $0x551a,0x4(%esp)
    3007:	00 
    3008:	89 04 24             	mov    %eax,(%esp)
    300b:	e8 c8 0d 00 00       	call   3dd8 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    3031:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    ...
    3044:	c7 44 24 04 38 55 00 	movl   $0x5538,0x4(%esp)
    304b:	00 
    304c:	89 04 24             	mov    %eax,(%esp)
    304f:	e8 84 0d 00 00       	call   3dd8 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3098:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    ...
    30ab:	c7 44 24 04 70 55 00 	movl   $0x5570,0x4(%esp)
    30b2:	00 
    30b3:	89 04 24             	mov    %eax,(%esp)
    30b6:	e8 1d 0d 00 00       	call   3dd8 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    30ca:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    30cf:	c7 44 24 04 98 55 00 	movl   $0x5598,0x4(%esp)
    30d6:	00 
    30d7:	89 04 24             	mov    %eax,(%esp)
    30da:	e8 f9 0c 00 00       	call   3dd8 <printf>
    exit();
  ...
  if(c != a){
    ...
    3119:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    ...
    312c:	c7 44 24 04 c8 55 00 	movl   $0x55c8,0x4(%esp)
    3133:	00 
    3134:	89 04 24             	mov    %eax,(%esp)
    3137:	e8 9c 0c 00 00       	call   3dd8 <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    3160:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    3165:	c7 44 24 04 91 45 00 	movl   $0x4591,0x4(%esp)
    316c:	00 
    316d:	89 04 24             	mov    %eax,(%esp)
    3170:	e8 63 0c 00 00       	call   3dd8 <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31e1:	c7 44 24 04 e5 44 00 	movl   $0x44e5,0x4(%esp)
    31e8:	00 
    31e9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31f0:	e8 e3 0b 00 00       	call   3dd8 <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3244:	00 
    3245:	c7 44 24 04 4a 45 00 	movl   $0x454a,0x4(%esp)
    324c:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32e5:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    32ea:	c7 44 24 04 02 56 00 	movl   $0x5602,0x4(%esp)
    32f1:	00 
    32f2:	89 04 24             	mov    %eax,(%esp)
    32f5:	e8 de 0a 00 00       	call   3dd8 <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    332b:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    3330:	c7 44 24 04 1d 56 00 	movl   $0x561d,0x4(%esp)
    3337:	00 
    3338:	89 04 24             	mov    %eax,(%esp)
    333b:	e8 98 0a 00 00       	call   3dd8 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    3371:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    3376:	c7 44 24 04 2b 56 00 	movl   $0x562b,0x4(%esp)
    337d:	00 
    337e:	89 04 24             	mov    %eax,(%esp)
    3381:	e8 52 0a 00 00       	call   3dd8 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33e3:	c7 04 24 3a 56 00 00 	movl   $0x563a,(%esp)
    33ea:	e8 89 08 00 00       	call   3c78 <link>
    33ef:	83 f8 ff             	cmp    $0xffffffff,%eax
    33f2:	74 1a                	je     340e <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33f4:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    33f9:	c7 44 24 04 45 56 00 	movl   $0x5645,0x4(%esp)
    3400:	00 
    3401:	89 04 24             	mov    %eax,(%esp)
    3404:	e8 cf 09 00 00       	call   3dd8 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    3421:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    3426:	c7 44 24 04 5e 56 00 	movl   $0x565e,0x4(%esp)
    342d:	00 
    342e:	89 04 24             	mov    %eax,(%esp)
    3431:	e8 a2 09 00 00       	call   3dd8 <printf>
}
    3436:	c9                   	leave  
    3437:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    343e:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    3443:	c7 44 24 04 6b 56 00 	movl   $0x566b,0x4(%esp)
    344a:	00 
    344b:	89 04 24             	mov    %eax,(%esp)
    344e:	e8 85 09 00 00       	call   3dd8 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    346b:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    3470:	c7 44 24 04 75 56 00 	movl   $0x5675,0x4(%esp)
    3477:	00 
    3478:	89 04 24             	mov    %eax,(%esp)
    347b:	e8 58 09 00 00       	call   3dd8 <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3493:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    3498:	c7 44 24 04 86 56 00 	movl   $0x5686,0x4(%esp)
    349f:	00 
    34a0:	89 04 24             	mov    %eax,(%esp)
    34a3:	e8 30 09 00 00       	call   3dd8 <printf>
}
    34a8:	c9                   	leave  
    34a9:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34b0:	c7 04 24 93 56 00 00 	movl   $0x5693,(%esp)
  ...
  if(pid == 0){
    ...
    34da:	c7 04 85 20 5f 00 00 	movl   $0x56a0,0x5f20(,%eax,4)
    34e1:	a0 56 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    34f9:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    34fe:	c7 44 24 04 7d 57 00 	movl   $0x577d,0x4(%esp)
    3505:	00 
    3506:	89 04 24             	mov    %eax,(%esp)
    3509:	e8 ca 08 00 00       	call   3dd8 <printf>
    exec("echo", args);
    350e:	c7 44 24 04 20 5f 00 	movl   $0x5f20,0x4(%esp)
    3515:	00 
    3516:	c7 04 24 a4 41 00 00 	movl   $0x41a4,(%esp)
    351d:	e8 2e 07 00 00       	call   3c50 <exec>
    printf(stdout, "bigarg test ok\n");
    3522:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    3527:	c7 44 24 04 8a 57 00 	movl   $0x578a,0x4(%esp)
    352e:	00 
    352f:	89 04 24             	mov    %eax,(%esp)
    3532:	e8 a1 08 00 00       	call   3dd8 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3537:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    353e:	00 
    353f:	c7 04 24 93 56 00 00 	movl   $0x5693,(%esp)
    ...
    3564:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    3569:	c7 44 24 04 9a 57 00 	movl   $0x579a,0x4(%esp)
    3570:	00 
    3571:	89 04 24             	mov    %eax,(%esp)
    3574:	e8 5f 08 00 00       	call   3dd8 <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    358a:	00 
    358b:	c7 04 24 93 56 00 00 	movl   $0x5693,(%esp)
  ...
  if(fd < 0){
    ...
    35a0:	a1 fc 5e 00 00       	mov    0x5efc,%eax
    35a5:	c7 44 24 04 b3 57 00 	movl   $0x57b3,0x4(%esp)
    35ac:	00 
    35ad:	89 04 24             	mov    %eax,(%esp)
    35b0:	e8 23 08 00 00       	call   3dd8 <printf>
    exit();
  ...
  unlink("bigarg-ok");
    35c5:	c7 04 24 93 56 00 00 	movl   $0x5693,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35e1:	c7 44 24 04 c8 57 00 	movl   $0x57c8,0x4(%esp)
    35e8:	00 
    35e9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    35f0:	e8 e3 07 00 00       	call   3dd8 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36cb:	c7 44 24 04 d5 57 00 	movl   $0x57d5,0x4(%esp)
    36d2:	00 
    36d3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    36da:	e8 f9 06 00 00       	call   3dd8 <printf>
    ...
    3702:	c7 44 24 04 e1 57 00 	movl   $0x57e1,0x4(%esp)
    3709:	00 
    370a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3711:	e8 c2 06 00 00       	call   3dd8 <printf>
      break;
    ...
    374e:	c7 44 24 04 f1 57 00 	movl   $0x57f1,0x4(%esp)
    3755:	00 
    3756:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    375d:	e8 76 06 00 00       	call   3dd8 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3872:	c7 44 24 04 01 58 00 	movl   $0x5801,0x4(%esp)
    3879:	00 
    387a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3881:	e8 52 05 00 00       	call   3dd8 <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    388f:	a1 00 5f 00 00       	mov    0x5f00,%eax
    3894:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    389a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    389f:	a3 00 5f 00 00       	mov    %eax,0x5f00
  return randstate;
    38a4:	a1 00 5f 00 00       	mov    0x5f00,%eax
}
    38a9:	5d                   	pop    %ebp
    38aa:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3900:	00 
    3901:	c7 04 24 2b 58 00 00 	movl   $0x582b,(%esp)
...
00003ce8 <mtx_lock>:
SYSCALL(mtx_lock)
    3ce8:	b8 1c 00 00 00       	mov    $0x1c,%eax
    3ced:	cd 40                	int    $0x40
    3cef:	c3                   	ret    

00003cf0 <mtx_unlock>:
SYSCALL(mtx_unlock)
    3cf0:	b8 1d 00 00 00       	mov    $0x1d,%eax
    3cf5:	cd 40                	int    $0x40
    3cf7:	c3                   	ret    
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    3d19:	e8 1a ff ff ff       	call   3c38 <write>
}
    3d1e:	c9                   	leave  
    3d1f:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    3d28:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    3d2f:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3d33:	74 17                	je     3d4c <printint+0x2c>
    3d35:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3d39:	79 11                	jns    3d4c <printint+0x2c>
    neg = 1;
    3d3b:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    3d42:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d45:	f7 d8                	neg    %eax
    3d47:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d4a:	eb 06                	jmp    3d52 <printint+0x32>
  } else {
    x = xx;
    3d4c:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d4f:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    3d52:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    3d59:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    3d5c:	8d 41 01             	lea    0x1(%ecx),%eax
    3d5f:	89 45 f4             	mov    %eax,-0xc(%ebp)
    3d62:	8b 5d 10             	mov    0x10(%ebp),%ebx
    3d65:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d68:	ba 00 00 00 00       	mov    $0x0,%edx
    3d6d:	f7 f3                	div    %ebx
    3d6f:	89 d0                	mov    %edx,%eax
    3d71:	0f b6 80 04 5f 00 00 	movzbl 0x5f04(%eax),%eax
    3d78:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    3d7c:	8b 75 10             	mov    0x10(%ebp),%esi
    3d7f:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d82:	ba 00 00 00 00       	mov    $0x0,%edx
    3d87:	f7 f6                	div    %esi
    3d89:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d8c:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3d90:	75 c7                	jne    3d59 <printint+0x39>
  if(neg)
    3d92:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3d96:	74 10                	je     3da8 <printint+0x88>
    buf[i++] = '-';
    3d98:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3d9b:	8d 50 01             	lea    0x1(%eax),%edx
    3d9e:	89 55 f4             	mov    %edx,-0xc(%ebp)
    3da1:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    3da6:	eb 1f                	jmp    3dc7 <printint+0xa7>
    3da8:	eb 1d                	jmp    3dc7 <printint+0xa7>
    putc(fd, buf[i]);
    3daa:	8d 55 dc             	lea    -0x24(%ebp),%edx
    3dad:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3db0:	01 d0                	add    %edx,%eax
    3db2:	0f b6 00             	movzbl (%eax),%eax
    3db5:	0f be c0             	movsbl %al,%eax
    3db8:	89 44 24 04          	mov    %eax,0x4(%esp)
    3dbc:	8b 45 08             	mov    0x8(%ebp),%eax
    3dbf:	89 04 24             	mov    %eax,(%esp)
    3dc2:	e8 31 ff ff ff       	call   3cf8 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    3dc7:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    3dcb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3dcf:	79 d9                	jns    3daa <printint+0x8a>
    putc(fd, buf[i]);
}
    3dd1:	83 c4 30             	add    $0x30,%esp
    3dd4:	5b                   	pop    %ebx
    3dd5:	5e                   	pop    %esi
    3dd6:	5d                   	pop    %ebp
    3dd7:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    3ddb:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    3dde:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    3de5:	8d 45 0c             	lea    0xc(%ebp),%eax
    3de8:	83 c0 04             	add    $0x4,%eax
    3deb:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    3dee:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    3df5:	e9 7c 01 00 00       	jmp    3f76 <printf+0x19e>
    c = fmt[i] & 0xff;
    3dfa:	8b 55 0c             	mov    0xc(%ebp),%edx
    3dfd:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3e00:	01 d0                	add    %edx,%eax
    3e02:	0f b6 00             	movzbl (%eax),%eax
    3e05:	0f be c0             	movsbl %al,%eax
    3e08:	25 ff 00 00 00       	and    $0xff,%eax
    3e0d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    3e10:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3e14:	75 2c                	jne    3e42 <printf+0x6a>
      if(c == '%'){
    3e16:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3e1a:	75 0c                	jne    3e28 <printf+0x50>
        state = '%';
    3e1c:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    3e23:	e9 4a 01 00 00       	jmp    3f72 <printf+0x19a>
      } else {
        putc(fd, c);
    3e28:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3e2b:	0f be c0             	movsbl %al,%eax
    3e2e:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e32:	8b 45 08             	mov    0x8(%ebp),%eax
    3e35:	89 04 24             	mov    %eax,(%esp)
    3e38:	e8 bb fe ff ff       	call   3cf8 <putc>
    3e3d:	e9 30 01 00 00       	jmp    3f72 <printf+0x19a>
      }
    } else if(state == '%'){
    3e42:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    3e46:	0f 85 26 01 00 00    	jne    3f72 <printf+0x19a>
      if(c == 'd'){
    3e4c:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    3e50:	75 2d                	jne    3e7f <printf+0xa7>
        printint(fd, *ap, 10, 1);
    3e52:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e55:	8b 00                	mov    (%eax),%eax
    3e57:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    3e5e:	00 
    3e5f:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    3e66:	00 
    3e67:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e6b:	8b 45 08             	mov    0x8(%ebp),%eax
    3e6e:	89 04 24             	mov    %eax,(%esp)
    3e71:	e8 aa fe ff ff       	call   3d20 <printint>
        ap++;
    3e76:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3e7a:	e9 ec 00 00 00       	jmp    3f6b <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    3e7f:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    3e83:	74 06                	je     3e8b <printf+0xb3>
    3e85:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    3e89:	75 2d                	jne    3eb8 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    3e8b:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e8e:	8b 00                	mov    (%eax),%eax
    3e90:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    3e97:	00 
    3e98:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    3e9f:	00 
    3ea0:	89 44 24 04          	mov    %eax,0x4(%esp)
    3ea4:	8b 45 08             	mov    0x8(%ebp),%eax
    3ea7:	89 04 24             	mov    %eax,(%esp)
    3eaa:	e8 71 fe ff ff       	call   3d20 <printint>
        ap++;
    3eaf:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3eb3:	e9 b3 00 00 00       	jmp    3f6b <printf+0x193>
      } else if(c == 's'){
    3eb8:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    3ebc:	75 45                	jne    3f03 <printf+0x12b>
        s = (char*)*ap;
    3ebe:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3ec1:	8b 00                	mov    (%eax),%eax
    3ec3:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    3ec6:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    3eca:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3ece:	75 09                	jne    3ed9 <printf+0x101>
          s = "(null)";
    3ed0:	c7 45 f4 66 58 00 00 	movl   $0x5866,-0xc(%ebp)
        while(*s != 0){
    3ed7:	eb 1e                	jmp    3ef7 <printf+0x11f>
    3ed9:	eb 1c                	jmp    3ef7 <printf+0x11f>
          putc(fd, *s);
    3edb:	8b 45 f4             	mov    -0xc(%ebp),%eax
    ...
    3eee:	e8 05 fe ff ff       	call   3cf8 <putc>
          s++;
    3ef3:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    3eff:	75 da                	jne    3edb <printf+0x103>
    3f01:	eb 68                	jmp    3f6b <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    3f03:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    3f07:	75 1d                	jne    3f26 <printf+0x14e>
        putc(fd, *ap);
    ...
    3f1b:	e8 d8 fd ff ff       	call   3cf8 <putc>
        ap++;
    3f20:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3f24:	eb 45                	jmp    3f6b <printf+0x193>
      } else if(c == '%'){
    3f26:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3f2a:	75 17                	jne    3f43 <printf+0x16b>
        putc(fd, c);
    ...
    3f3c:	e8 b7 fd ff ff       	call   3cf8 <putc>
    3f41:	eb 28                	jmp    3f6b <printf+0x193>
      } else {
    ...
    3f51:	e8 a2 fd ff ff       	call   3cf8 <putc>
        putc(fd, c);
    ...
    3f66:	e8 8d fd ff ff       	call   3cf8 <putc>
      }
      state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3f83:	0f 85 71 fe ff ff    	jne    3dfa <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
{
    3f8b:	55                   	push   %ebp
    3f8c:	89 e5                	mov    %esp,%ebp
    3f8e:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    3f91:	8b 45 08             	mov    0x8(%ebp),%eax
    3f94:	83 e8 08             	sub    $0x8,%eax
    3f97:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3f9a:	a1 a8 5f 00 00       	mov    0x5fa8,%eax
    3f9f:	89 45 fc             	mov    %eax,-0x4(%ebp)
    3fa2:	eb 24                	jmp    3fc8 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3fa4:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fa7:	8b 00                	mov    (%eax),%eax
    3fa9:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    3fac:	77 12                	ja     3fc0 <free+0x35>
    3fae:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3fb1:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    3fb4:	77 24                	ja     3fda <free+0x4f>
    3fb6:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fb9:	8b 00                	mov    (%eax),%eax
    3fbb:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    3fbe:	77 1a                	ja     3fda <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    400e:	8b 00                	mov    (%eax),%eax
    4010:	8b 10                	mov    (%eax),%edx
    4012:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4015:	89 10                	mov    %edx,(%eax)
    4017:	eb 0a                	jmp    4023 <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
    4019:	8b 45 fc             	mov    -0x4(%ebp),%eax
    401c:	8b 10                	mov    (%eax),%edx
    401e:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4021:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    4023:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4026:	8b 40 04             	mov    0x4(%eax),%eax
    4029:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    4030:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4033:	01 d0                	add    %edx,%eax
    4035:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4038:	75 20                	jne    405a <free+0xcf>
    p->s.size += bp->s.size;
    403a:	8b 45 fc             	mov    -0x4(%ebp),%eax
    403d:	8b 50 04             	mov    0x4(%eax),%edx
    4040:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4043:	8b 40 04             	mov    0x4(%eax),%eax
    4046:	01 c2                	add    %eax,%edx
    4048:	8b 45 fc             	mov    -0x4(%ebp),%eax
    404b:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    404e:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4051:	8b 10                	mov    (%eax),%edx
    4053:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4056:	89 10                	mov    %edx,(%eax)
    4058:	eb 08                	jmp    4062 <free+0xd7>
  } else
    p->s.ptr = bp;
    405a:	8b 45 fc             	mov    -0x4(%ebp),%eax
    405d:	8b 55 f8             	mov    -0x8(%ebp),%edx
    4060:	89 10                	mov    %edx,(%eax)
  freep = p;
    4062:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4065:	a3 a8 5f 00 00       	mov    %eax,0x5fa8
}
    406a:	c9                   	leave  
    406b:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    406f:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    4072:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    4079:	77 07                	ja     4082 <morecore+0x16>
    nu = 4096;
    407b:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    4082:	8b 45 08             	mov    0x8(%ebp),%eax
    4085:	c1 e0 03             	shl    $0x3,%eax
    4088:	89 04 24             	mov    %eax,(%esp)
    408b:	e8 10 fc ff ff       	call   3ca0 <sbrk>
    4090:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    4093:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    4097:	75 07                	jne    40a0 <morecore+0x34>
    return 0;
    4099:	b8 00 00 00 00       	mov    $0x0,%eax
    409e:	eb 22                	jmp    40c2 <morecore+0x56>
  hp = (Header*)p;
    40a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    40a3:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    40a6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40a9:	8b 55 08             	mov    0x8(%ebp),%edx
    40ac:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    40af:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40b2:	83 c0 08             	add    $0x8,%eax
    40b5:	89 04 24             	mov    %eax,(%esp)
    40b8:	e8 ce fe ff ff       	call   3f8b <free>
  return freep;
    40bd:	a1 a8 5f 00 00       	mov    0x5fa8,%eax
}
    40c2:	c9                   	leave  
    40c3:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    40cd:	83 c0 07             	add    $0x7,%eax
    40d0:	c1 e8 03             	shr    $0x3,%eax
    40d3:	83 c0 01             	add    $0x1,%eax
    40d6:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    40d9:	a1 a8 5f 00 00       	mov    0x5fa8,%eax
    40de:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40e1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40e5:	75 23                	jne    410a <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40e7:	c7 45 f0 a0 5f 00 00 	movl   $0x5fa0,-0x10(%ebp)
    40ee:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40f1:	a3 a8 5f 00 00       	mov    %eax,0x5fa8
    40f6:	a1 a8 5f 00 00       	mov    0x5fa8,%eax
    40fb:	a3 a0 5f 00 00       	mov    %eax,0x5fa0
    base.s.size = 0;
    4100:	c7 05 a4 5f 00 00 00 	movl   $0x0,0x5fa4
    4107:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    410a:	8b 45 f0             	mov    -0x10(%ebp),%eax
    410d:	8b 00                	mov    (%eax),%eax
    410f:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    4112:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4115:	8b 40 04             	mov    0x4(%eax),%eax
    4118:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    411b:	72 4d                	jb     416a <malloc+0xa6>
      if(p->s.size == nunits)
    411d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4120:	8b 40 04             	mov    0x4(%eax),%eax
    4123:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    4126:	75 0c                	jne    4134 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    4128:	8b 45 f4             	mov    -0xc(%ebp),%eax
    412b:	8b 10                	mov    (%eax),%edx
    412d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4130:	89 10                	mov    %edx,(%eax)
    4132:	eb 26                	jmp    415a <malloc+0x96>
      else {
        p->s.size -= nunits;
    4134:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4137:	8b 40 04             	mov    0x4(%eax),%eax
    413a:	2b 45 ec             	sub    -0x14(%ebp),%eax
    413d:	89 c2                	mov    %eax,%edx
    413f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4142:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    4145:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4148:	8b 40 04             	mov    0x4(%eax),%eax
    414b:	c1 e0 03             	shl    $0x3,%eax
    414e:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    4151:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4154:	8b 55 ec             	mov    -0x14(%ebp),%edx
    4157:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    415a:	8b 45 f0             	mov    -0x10(%ebp),%eax
    415d:	a3 a8 5f 00 00       	mov    %eax,0x5fa8
      return (void*)(p + 1);
    4162:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4165:	83 c0 08             	add    $0x8,%eax
    4168:	eb 38                	jmp    41a2 <malloc+0xde>
    }
    if(p == freep)
    416a:	a1 a8 5f 00 00       	mov    0x5fa8,%eax
    416f:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    4172:	75 1b                	jne    418f <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    4174:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4177:	89 04 24             	mov    %eax,(%esp)
    417a:	e8 ed fe ff ff       	call   406c <morecore>
    417f:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4182:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4186:	75 07                	jne    418f <malloc+0xcb>
        return 0;
    4188:	b8 00 00 00 00       	mov    $0x0,%eax
    418d:	eb 13                	jmp    41a2 <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    4192:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4195:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4198:	8b 00                	mov    (%eax),%eax
    419a:	89 45 f4             	mov    %eax,-0xc(%ebp)
      return (void*)(p + 1);
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
    ...
    419d:	e9 70 ff ff ff       	jmp    4112 <malloc+0x4e>
}
    41a2:	c9                   	leave  
    41a3:	c3                   	ret    
