...
main(int argc, char *argv[])
{
 ...
 113:	c7 44 24 04 4c 0b 00 	movl   $0xb4c,0x4(%esp)
 11a:	00 
 11b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
 122:	e8 56 06 00 00       	call   77d <printf>
    exit();
 ...
 1a5:	c7 44 24 04 6c 0b 00 	movl   $0xb6c,0x4(%esp)
 1ac:	00 
 1ad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 1b4:	e8 c4 05 00 00       	call   77d <printf>
      exit();
...
putc(int fd, char c)
{
 ...
 6be:	e8 1a ff ff ff       	call   5dd <write>
}
 6c3:	c9                   	leave  
 6c4:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 716:	0f b6 80 50 0e 00 00 	movzbl 0xe50(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 873:	75 09                	jne    87e <printf+0x101>
          s = "(null)";
 875:	c7 45 f4 82 0b 00 00 	movl   $0xb82,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 93f:	a1 88 0e 00 00       	mov    0xe88,%eax
...
free(void *ap)
{
 ...
 a0a:	a3 88 0e 00 00       	mov    %eax,0xe88
}
 a0f:	c9                   	leave  
 a10:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a30:	e8 10 fc ff ff       	call   645 <sbrk>
 ...
 a5d:	e8 ce fe ff ff       	call   930 <free>
  return freep;
 a62:	a1 88 0e 00 00       	mov    0xe88,%eax
}
 a67:	c9                   	leave  
 a68:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a7b:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a7e:	a1 88 0e 00 00       	mov    0xe88,%eax
 a83:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a86:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a8a:	75 23                	jne    aaf <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a8c:	c7 45 f0 80 0e 00 00 	movl   $0xe80,-0x10(%ebp)
 a93:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a96:	a3 88 0e 00 00       	mov    %eax,0xe88
 a9b:	a1 88 0e 00 00       	mov    0xe88,%eax
 aa0:	a3 80 0e 00 00       	mov    %eax,0xe80
    base.s.size = 0;
 aa5:	c7 05 84 0e 00 00 00 	movl   $0x0,0xe84
 aac:	00 00 00 
  }
 ...
 b0d:	eb 38                	jmp    b47 <malloc+0xde>
    ...
    if(p == freep)
 b0f:	a1 88 0e 00 00       	mov    0xe88,%eax
